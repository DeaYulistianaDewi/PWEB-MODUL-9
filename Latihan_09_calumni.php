...
if($_SERVER["REQUEST_METHOD"]== "POST"){
    ...
    if(isset($_FILES['foto'])&& $_FILES['foto']['error']== 0){
        $target_dir = "";
        $target_file = $target_dir.basename($FILES["foto"]["name"]);
        $uploadOk = 1;
        $imageFileType = strtolower(pathinfo($target_file_PATHINFO_EXTENSION));
    ...
    if($uploadOk == 0){
        ...
        if(move_upload_file($_FILES["foto"]["tmp_name"],$target_file)){
    ...
    <div class="container mt-5">
        ...
        <form method="POST"action="" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" clss="form-control" id="tahun_lulus" name="tahun_lulus" required>
            </div>
            <div class="mb-3">
